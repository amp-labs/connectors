...
func (p PathItem) RetrieveSchemaOperationGet(aliases handy.Aliases) (*Schema, bool, error) {
	...
	fields, err := extractFieldsFromArrayItem(name, schema)
...
func extractFieldsFromArrayItem(objectName string, schema *openapi3.Schema) ([]string, error) {
