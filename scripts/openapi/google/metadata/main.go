...
import (
	...
	"github.com/amp-labs/connectors/scripts/openapi/google/metadata/calendar"
	"github.com/amp-labs/connectors/scripts/openapi/google/metadata/people"
...
func main() {
	...
	lists.Add(google.ModuleCalendar, calendar.Objects()...)
	lists.Add(google.ModulePeople, people.Objects()...)
...
func urlPath(module common.ModuleID, object metadatadef.Schema) string {
	switch module {
	case google.ModuleCalendar:
		return "calendar/v3" + object.URLPath
	case google.ModulePeople:
		return object.URLPath
	default:
		return object.URLPath
	}
}
