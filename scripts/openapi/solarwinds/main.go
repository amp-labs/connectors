...
import (
	...
	"github.com/amp-labs/connectors/scripts/openapi/solarwinds/metadata"
...
func main() {
	...
	for _, object := range objects {
		...
		for _, field := range object.Fields {
			schemas.Add("root", object.ObjectName, object.DisplayName, object.URLPath, object.ResponseKey,
