...
var (
	...
	displayNameOverride = map[string]string{ // nolint:gochecknoglobals
		...
		"balance/history":                "Balance History Transactions",
		"invoices":                       "Invoices",
		"terminal/locations":             "Terminal Locations",
		"payment_intents":                "Payment Intents",
		"payment_methods":                "Payment Methods",
		"refunds":                        "API Method Refunds",
		"reporting/report_runs":          "Financial Report Runs",
		"reporting/report_types":         "Financial Report Types",
		...
		"topups":                         "Top-ups",
		"radar/value_lists":              "Radar Value Lists",
		"identity/verification_reports":  "Verification Reports",
		"identity/verification_sessions": "Verification Sessions",
