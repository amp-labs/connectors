...
var (
	...
	edfsObjectNameToResponseField = datautils.NewDefaultMap(map[string]string{
		"": "edfs",
	},
...
func populateEdfs(
	...
	explorer, err := openapi.EdfsFileManager.GetExplorer(
	...
	objects, err := explorer.ReadObjectsGet(
		nil,
		nil, nil,
		api3.CustomMappingObjectCheck(edfsObjectNameToResponseField),
	)
