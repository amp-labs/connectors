...
func main() {
	...
	objectMetadata := make(map[string]staticschema.Object[staticschema.ObjectFieldsV1])
	...
	goutils.MustBeNil(metadata.FileManager.SaveSchemas(&staticschema.Metadata[staticschema.ObjectFieldsV1]{
		Modules: map[common.ModuleID]staticschema.Module[staticschema.ObjectFieldsV1]{
...
func generateMetadata(objDefs map[string]string,
	doc openapi2.T, objectMetadata map[string]staticschema.Object[staticschema.ObjectFieldsV1],
) map[string]staticschema.Object[staticschema.ObjectFieldsV1] {
	for obj, dfn := range objDefs {
		...
		om := staticschema.Object[staticschema.ObjectFieldsV1]{
			DisplayName: obj,
