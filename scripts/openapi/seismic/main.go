...
import (
	...
	"github.com/amp-labs/connectors/scripts/openapi/seismic/metadata"
	"github.com/amp-labs/connectors/tools/fileconv/api3"
	"github.com/amp-labs/connectors/tools/scrapper"
)

var (
	//go:embed seismic_reporting_openapi.json
	specs []byte
...
func main() {
	...
	for _, object := range objects {
		...
		for _, field := range object.Fields {
			schemas.Add("reporting", object.ObjectName, object.DisplayName, object.URLPath, object.ResponseKey,
