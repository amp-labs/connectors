...
func createCampaign(ctx context.Context, conn *smartleadv2.Connector, payload *campaignPayload) *common.WriteResult {
...
func removeCampaign(ctx context.Context, conn *smartleadv2.Connector, viewID string) {
