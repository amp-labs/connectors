...
**`ValidateCreateDelete`**, **`ValidateCreateUpdateDelete`**, and **`ValidateUpdate`** use `CRDTestSuite`, `CRUDTestSuite`, and `UpdateTestSuite` respectively to control scenario configuration.
