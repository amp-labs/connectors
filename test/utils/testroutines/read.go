...
// ReadConnector provides a procedure to test connectors.ReadConnector
func (r routines) ReadConnector(t *testing.T, testSuite Read, builder ConnectorBuilder[connectors.ReadConnector]) {
	...
	output, err := conn.Read(context.Background(), testSuite.Input)
