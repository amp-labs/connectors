...
// AddMismatch compares two data structures using github.com/go-test/deep.Equal
...
func (r *CompareResult) AddMismatch(dataName string, gotData, expectedData any) bool {
	...
	message := fmt.Sprintf("%v mistmatch:\n%v", dataName, strings.Join(list, "\n"))
