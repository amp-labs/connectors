...
type Condition interface {
	RunCondition(w http.ResponseWriter, r *http.Request) bool
}
...
func (c Check) RunCondition(w http.ResponseWriter, r *http.Request) bool {
	return c(w, r)
}

func (o Or) RunCondition(w http.ResponseWriter, r *http.Request) bool {
	if len(o) == 0 {
		return false
	}
...
func (a And) RunCondition(w http.ResponseWriter, r *http.Request) bool {
	if len(a) == 0 {
		return false
	}
