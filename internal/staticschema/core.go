...
const CoreModuleID common.ModuleID = "core"
...
func (r *Metadata) ObjectNames() handy.UniqueLists[common.ModuleID, string] {
	...
	for key, value := range r.Modules {
		...
		if key == CoreModuleID {
			// Empty ModuleID could be passed referring to the same core module.
...
// In case an empty ModuleID is provided we fall back to the default core module id.
