		...
		},
		{
			...
			Input: testconn.ReadByIdsParams{
				...
				Fields: []string{"firstName", "customField53",
					"AMPERSAND-phone111", "AMPERSAND-phone222", "AMPERSAND-phone333", "AMPERSAND-phone-default",
				},
			},
			...
			Expected: []common.ReadResultRow{{
				...
				Fields: map[string]any{
					...
					"ampersand-phone111":      "+123",
					"ampersand-phone222":      nil,
					"ampersand-phone333":      nil,
					"ampersand-phone-default": "111",
				},
				...
				Fields: map[string]any{
					...
					"ampersand-phone111":      nil,
					"ampersand-phone222":      "+456",
					"ampersand-phone333":      nil,
					"ampersand-phone-default": "222",
				},
				...
				Fields: map[string]any{
					...
					"ampersand-phone111":      nil,
					"ampersand-phone222":      "+456",
					"ampersand-phone333":      "+789",
					"ampersand-phone-default": "333",
				},
