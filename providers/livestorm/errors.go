...
var (
	...
	// ErrSessionIDForWriteRequired is returned when writing session_people_bulk without session_id in RecordData.
	ErrSessionIDForWriteRequired = errors.New("write session_people_bulk requires session_id in RecordData")
)
