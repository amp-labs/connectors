...
func (c *Connector) buildSessionChatMessagesReadURL(params common.ReadParams) (*urlbuilder.URL, error) {
	...
	endpointURL, err := buildURLWithVersion(c.ProviderInfo().BaseURL, "", "sessions", sessionID, "chat_messages")
	if err != nil {
		return nil, err
	}
...
func (c *Connector) buildJobReadURL(params common.ReadParams) (*urlbuilder.URL, error) {
	...
	return buildURLWithVersion(c.ProviderInfo().BaseURL, "", "jobs", jobID)
}
