...
// VerifyWebhookMessage is a stub that always succeeds; TODO: implement verification logic for Gong webhooks.
...
// Gong currently only supports Subscribe for Call creation events.
// If Gong ships a new trigger (or an unrelated request hits the endpoint)
// we mark it Other.
