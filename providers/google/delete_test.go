...
func TestDelete(t *testing.T) { // nolint:funlen,cyclop
	...
	tests := []testroutines.Delete{
		...
		},
		{
			...
			Input:  common.DeleteParams{ObjectName: "videos", RecordId: "123456789"},
			Server: mockserver.Dummy(),
			ExpectedErrs: []error{
		...
		},
		{
			...
			Server: mockserver.Conditional{
				...
				If: mockcond.And{
					...
					mockcond.PathSuffix("/calendar/v3/users/me/calendarList/en.italian#holiday@group.v.calendar.google.com"), // nolint:lll
				},
