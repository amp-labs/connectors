...
func TestWrite(t *testing.T) { // nolint:funlen,cyclop
	...
	errorCalendarNoColor := testutils.DataFromFile(t, "write/calendarList/missing-color.json")
	responseInsertCalendar := testutils.DataFromFile(t, "write/calendarList/insert.json")
	...
	tests := []testroutines.Write{
		...
		},
		{
			...
			Server: mockserver.Conditional{
				...
				If: mockcond.And{
					mockcond.MethodPUT(),
					mockcond.PathSuffix("/calendar/v3/users/me/calendarList/en.usa#holiday@group.v.calendar.google.com"), // nolint:lll
				},
