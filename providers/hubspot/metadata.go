...
func (c *Connector) describeObject(ctx context.Context, objectName string) (*common.ObjectMetadata, error) {
	if crmObjectsOutsideTheObjectAPI.Has(objectName) {
		return c.describeObjectOutsideCRMObjectAPIs(ctx, objectName)
	}

	return c.describeObjectCRMObjectAPIs(ctx, objectName)
}
...
func (c *Connector) describeObjectCRMObjectAPIs(
...
func (c *Connector) describeObjectOutsideCRMObjectAPIs(
	ctx context.Context, objectName string,
) (*common.ObjectMetadata, error) {
