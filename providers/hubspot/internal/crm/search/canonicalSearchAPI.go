	...
	return common.ParseResult(
		...
		readhelper.ChainedMarshaller(
			...
			func(rows []common.ReadResultRow) error {
				return s.associationsStrategy.FillAssociations(ctx, params.ObjectName, params.AssociatedObjects, rows)
			},
		),
		params.Fields,
	)
...
func makeFilterBody(params *common.SearchParams) *CanonicalSearchPayload {
	...
	// TODO Sorting is not supported by common.SearchParams at the moment
	// if params.SortBy != nil {
	//     payload.Sorts = params.SortBy
	// }
