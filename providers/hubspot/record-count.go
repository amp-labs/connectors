...
// It uses HubSpot's search endpoint with a minimal limit to get the total count efficiently.
//
// Example: counting contacts modified since a given time sends a search request like:
//
//	POST /crm/v3/objects/contacts/search
//	{"limit": 1, "filterGroups": [{"filters": [{"propertyName": "lastmodifieddate",
//	"operator": "GTE", "value": "2024-01-15T00:00:00.000Z"}]}]}
//
