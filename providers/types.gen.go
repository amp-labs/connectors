...
// ModuleInfo The registry of provider modules.
type ModuleInfo map[string]ProviderModuleInfo

// ModuleSupport The supported features for the module.
...
// ProviderModuleInfo defines model for ProviderModuleInfo.
type ProviderModuleInfo struct {
	BaseURL     string `json:"baseURL"`
	DisplayName string `json:"displayName"`

	// Support The supported features for the module.
	Support ModuleSupport `json:"support" validate:"required"`
}
