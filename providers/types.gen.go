...
const (
	CustomAuthInputFieldTypePassword CustomAuthInputFieldType = "password"
	CustomAuthInputFieldTypeSelect   CustomAuthInputFieldType = "select"
	CustomAuthInputFieldTypeText     CustomAuthInputFieldType = "text"
)
...
func (e CustomAuthInputFieldType) Valid() bool {
	switch e {
	case CustomAuthInputFieldTypePassword:
		return true
	case CustomAuthInputFieldTypeSelect:
		return true
	case CustomAuthInputFieldTypeText:
		return true
	default:
		return false
	}
...
type CustomAuthInput struct {
	...
	// FieldType How the frontend should render this input. "text" is an unmasked field (not sensitive), "password" is a masked field (sensitive), and "select" is a dropdown populated from options. Defaults to "password" when omitted.
...
// CustomAuthInputFieldType How the frontend should render this input. "text" is an unmasked field (not sensitive), "password" is a masked field (sensitive), and "select" is a dropdown populated from options. Defaults to "password" when omitted.
