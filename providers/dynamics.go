			...
			Input: []MetadataItemInput{
				{
					...
					Prompt:      "Copy the environment name (e.g. <code>org123456</code>) from your Web API endpoint URL. It appears right after <code>https://</code> and before <code>.api.</code>",
				},
				{
					Name:        "region",
					DisplayName: "Region",
					DocsURL:     "https://learn.microsoft.com/en-us/power-apps/developer/data-platform/webapi/compose-http-requests-handle-errors?view=dataverse-latest#web-api-url-and-versions",
					Prompt:      "Copy the region (e.g. <code>crm4</code>) from your Web API endpoint URL. It appears right after <code>.api.</code> and before <code>.dynamics.com</code>",
				},
			},
		},
	})
