...
func makeGetRecords(moduleID common.ModuleID, objectName string) common.NodeRecordsFunc {
	return func(node *ajson.Node) ([]*ajson.Node, error) {
		...
		return jsonquery.New(node).Array(responseFieldName, true)
	}
}
...
func (c *Connector) fetchReadCustomFields(ctx context.Context, config common.ReadParams) common.RawReadRecordFunc {
