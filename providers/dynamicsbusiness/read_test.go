		...
		},
		{
			...
			Server: mockserver.Switch{
				...
				Cases: mockserver.Cases{{
					...
					If: mockcond.And{
						mockcond.PathSuffix(
							"/v2.0/test-workspace/Production/api/v2.0/companies(test-company-id)/Customers"),
		...
		},
		{
			...
			Server: mockserver.Switch{
				...
				Cases: mockserver.Cases{{
					...
					If: mockcond.And{
						mockcond.PathSuffix(
							"/v2.0/test-workspace/Production/api/v2.0/companies(test-company-id)/BalanceSheets"),
						mockcond.QueryParam("$filter", "lastModifiedDateTime ge 2024-09-19T12:30:45.621Z"),
						mockcond.Header(http.Header{"Prefer": []string{"odata.maxpagesize=1"}}),
					},
