		...
		},
		{
			...
			Server: mockserver.Conditional{
				...
				If: mockcond.And{
					mockcond.MethodPOST(),
					mockcond.PathSuffix(
						"/v2.0/test-workspace/Production/api/v2.0/companies(test-company-id)/Contacts"),
				},
		...
		},
		{
			...
			Server: mockserver.Conditional{
				...
				If: mockcond.And{
					...
					mockcond.PathSuffix("/v2.0/test-workspace/Production/api/v2.0/companies(test-company-id)" +
