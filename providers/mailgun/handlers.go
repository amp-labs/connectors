...
// "2026-09-15T10:40:47.667Z" (RFC 3339, analytics/logs) and
// "2024-06-21T03:17:35" — the keys endpoint documents its timestamps as
// "ISO 8601 date-time format without timezone offset (UTC time)", which
// RFC 3339 parsing rejects, so it gets its own UTC layout.
//
//nolint:gochecknoglobals
